...
export function reducerApp(state, action) {
    ...
    switch (action.type) {
        // AppContext
        case ACTIONS.CLEAR:
            return { ...state, main_station_id: CONFIG.STATION_ID, map: {zoom: CONFIG.ZOOM}, mode: {mainStation: false, cycles: true}}
        ...
        case ACTIONS.REVERSE_CYCLES_DOCKS:
            return { ...state,  mode: {mainStation: state.mode.mainStation, cycles: !state.mode.cycles}}
